...
local enGBValues = {
  ...
  ["profession.recipes.buy_missing.tooltip"] = "Ask the bot to buy the first missing material from a nearby vendor.",
  ...
  ["inventory.item_use.err"] = "Use failed: %s",
  ["inventory.item_use.send_failed"] = "The item-use request could not be sent.",
  ["inventory.item_use.unavailable"] = "Item use via the bridge is unavailable.",
["inventory.item_use.reason.RATE_LIMIT"] = "Too many item-use requests. Try again in a moment.",
["inventory.item_use.reason.NO_BOT"] = "Bot not found.",
["inventory.item_use.reason.FORBIDDEN"] = "You are not allowed to control this bot.",
["inventory.item_use.reason.DUPLICATE"] = "This item-use request was already processed.",
["inventory.item_use.reason.NO_REQUESTER_SESSION"] = "Your game session is unavailable.",
["inventory.item_use.reason.NO_BOT_SESSION"] = "The bot session is unavailable.",
["inventory.item_use.reason.BOT_NOT_IN_WORLD"] = "The bot is not in the world.",
["inventory.item_use.reason.BOT_DEAD"] = "The bot is dead.",
["inventory.item_use.reason.BAD_POSITION"] = "This inventory position cannot be used.",
["inventory.item_use.reason.SOURCE_STALE"] = "The item changed or moved. Refresh the inventory and try again.",
["inventory.item_use.reason.UNSUPPORTED_ITEM"] = "This item is not supported for bridge item use.",
["inventory.item_use.reason.CANNOT_USE"] = "The bot cannot use this item.",
["inventory.item_use.reason.CAST_BUSY"] = "The bot is already casting.",
["inventory.item_use.reason.TARGET_REQUIRED"] = "This item requires a valid target.",
["inventory.item_use.reason.QUEST_NOT_ACCEPTED"] = "The quest started by this item could not be accepted.",
["inventory.item_use.reason.NOT_USABLE"] = "This item cannot be used right now.",
["inventory.item_use.reason.CAST_FAILED"] = "The item-use spell failed.",
["inventory.item_use.reason.MOVING"] = "The bot cannot use this item while moving.",
["inventory.item_use.reason.FAILED"] = "The item could not be used.",
["inventory.item_use.reason.TIMEOUT"] = "The item-use request timed out.",
["inventory.item_use.reason.BAD_RESPONSE"] = "The bridge returned an invalid item-use response.",
["inventory.item_use.reason.RESPONSE_MISMATCH"] = "The item-use response did not match the request.",
["inventory.item_use.reason.UNKNOWN"] = "The server returned an unknown item-use error.",
