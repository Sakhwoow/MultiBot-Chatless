...
["info.inventory.item_use.reason.UNKNOWN"] = "The server returned an unknown item-use error.",
  ...
  ["info.inventory.action_label"] = "Action",
  ["info.inventory.action.sell"] = "Sell",
  ["info.inventory.action.equip"] = "Equip",
  ["info.inventory.action.use"] = "Use",
  ["info.inventory.action.trade"] = "Trade",
  ["info.inventory.action.destroy"] = "Destroy",
  ["info.inventory.vendor_items"] = "Vendor items",
  ["info.inventory.open_vendor"] = "Open vendor window",
  ["info.talent.tab.talents"] = "Talents",
  ["info.talent.tab.glyphs"] = "Glyphs",
  ["info.talent.tab.custom_talents"] = "Custom Talents",
  ["info.talent.tab.custom_glyphs"] = "Custom Glyphs",
  ...
  ["tips.every.characterinfo"] = "Character Info|cffffffff\nShows the bot's skills, reputations and emblems.\n|cffff4444Requires bridge connection.|r|r\n\n|cffff0000Left-click to open|r\n|cff999999(Executed by: Bridge)|r",
